...
class ReportsService:
    ...
    def get_employees_by_quarter(self, year: int) -> dict[list[ReportEmployee]]:
    ...
    def get_above_average_hired_employees(self, year: int) -> dict[list[ReportEmployeeAboveAverage]]:
